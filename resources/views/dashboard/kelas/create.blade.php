  ...
  <div class="container-fluid p-0 px-md-3 w-100">
    ...
    <div class="col-md-8">
      <div class="bg-light border rounded-md-3 py-2">
        <form class="needs-validation form-create m-0" method="post" action="/dashboard/kelas">
          @csrf
          <div class="row m-0">
            <div class="col-md-6">
              <div class="form-floating mb-3">
                <input type="text" class="form-control @error('nm_kelas')is-invalid @enderror" name="nm_kelas" id="nm_kelas" placeholder="Nama Kelas"  value="{{ old('nm_kelas') }}"/>
