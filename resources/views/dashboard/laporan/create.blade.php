...
<main class="position-relative">
  <div class="container-fluid mb-3 p-0 px-md-3">
    <h2 class="fs-5 text-dark ms-2 ms-md-0 py-3 mb-0">Input Nilai Siswa</h2>
    <form class="form form-create" method="post" action="/dashboard/laporan">
      @csrf
      <div class="bg-light border rounded-md-3 overflow-hidden py-3">
        <div class="row px-3">
          ...
          <div class="col-md-6 mb-3">
            <div class="form-floating">
              <input type="text" class="form-control @error('kelas')is-invalid @enderror" name="kelas" id="kelas" placeholder="Kelas" value="{{ old('kelas') }}" />
          ...
          <div class="col-md-6 mb-3">
            <div class="form-floating">
              <input type="text" class="form-control @error('tahun_pelajaran')is-invalid @enderror" name="tahun_pelajaran" id="tahun_pelajaran" placeholder="Tahun Pelajaran" value="{{ old('tahun_pelajaran') }}" />
        ...
        <div class="col-md-6 mb-3">
          ...
          <select class="form-select p-3 mb-2 @error('skp_spiritual_predikat')is-invalid @enderror" aria-label="Default select" name="skp_spiritual_predikat">
            @php
                $predikat = ['A','B','C','D','E'];
                @endphp
            @if(empty(old('skp_spiritual_predikat')))
            <option selected value="">Predikat</option>
            @endif
            @foreach($predikat as $x)
            @if (old('skp_spiritual_predikat') === $x)
          ...
          @enderror
          <div class="form-floating">
            <textarea class="form-control @error('skp_spiritual_deskripsi')is-invalid @enderror" placeholder="Deskripsi" id="floatingTextarea2" style="height: 100px" name="skp_spiritual_deskripsi">{{ old('skp_spiritual_deskripsi') }}</textarea>
        ...
        <div class="col-md-6 mb-3">
          ...
          <select class="form-select p-3 mb-2 @error('skp_sosial_predikat')is-invalid @enderror" aria-label="Default select" name="skp_sosial_predikat">
            @php
                $predikat = ['A','B','C','D','E'];
                @endphp
            @if(empty(old('skp_sosial_predikat')))
            <option selected value="">Predikat</option>
            @endif
            @foreach($predikat as $x)
            @if (old('skp_sosial_predikat') === $x)
            <option value="{{ $x }}" selected>{{ $x }}</option>
            @else
            <option value="{{ $x }}">{{ $x }}</option>
            @endif
          ...
          @enderror
          <div class="form-floating">
            <textarea class="form-control @error('skp_sosial_deskripsi')is-invalid @enderror" placeholder="Deskripsi" id="floatingTextarea2" style="height: 100px" name="skp_sosial_deskripsi">{{ old('skp_sosial_deskripsi') }}</textarea>
            <label for="floatingTextarea2">Deskripsi</label>
      ...
      <div class="table-responsive mb-3">
        <table class="table table-bordered text-center mb-0" style="width: 1100px !important">
          ...
          <tbody id="tbody">
            ...
            @else
            <tr>
              <td><input type="text" class="form-control @error('nm_mapel[]')is-invalid @enderror" name="nm_mapel[]"/></td>
              <td><input type="text" class="form-control @error('p_kkm[]')is-invalid @enderror" name="p_kkm[]" /></td>
              <td><input type="text" class="form-control @error('p_angka[]')is-invalid @enderror" name="p_angka[]" /></td>
              <td>
              ...
              <td><textarea class="form-control @error('p_deskripsi[]')is-invalid @enderror" name="p_deskripsi[]" style="height: 0px !important"></textarea></td>
              <td><input type="text" class="form-control @error('k_kkm[]')is-invalid @enderror" name="k_kkm[]" /></td>
              <td><input type="text" class="form-control @error('k_angka[]')is-invalid @enderror" name="k_angka[]" /></td>
              <td>
              ...
              <td><textarea class="form-control @error('k_deskripsi[]')is-invalid @enderror" name="k_deskripsi[]" style="height: 0px !important"></textarea></td>
            </tr>
            @endif
          </tbody>
        </table>
